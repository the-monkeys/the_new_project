...
func (c *articleServiceClient) EditArticle(ctx context.Context, in *EditArticleReq, opts ...grpc.CallOption) (*EditArticleRes, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.ArticleService/EditArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) DeleteArticleById(ctx context.Context, in *GetArticleByIdReq, opts ...grpc.CallOption) (*DeleteArticleByIdRes, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.ArticleService/DeleteArticleById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ArticleService_EditArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.ArticleService/EditArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ArticleService_DeleteArticleById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.ArticleService/DeleteArticleById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ArticleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/api_gateway/pkg/article/pb/story.proto",
}
